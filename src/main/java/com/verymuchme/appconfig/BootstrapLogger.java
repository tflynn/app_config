...
/**
 * Logger in use during bootstrap phase only
 *
 ...
 *
 */
public class BootstrapLogger extends SpecialLogger  {
  ...
  private static final String LOGGER_NAME = "appconfig.bootstrap";
